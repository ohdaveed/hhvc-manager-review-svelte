			...
			steps: [
				...
				},
				{
					...
					callout: {
						...
						karl: 'Callout inside the Transaction Section specifics rich-text field. Keep the reinspection rates separate from the annual tier list so a reviewer does not mistake a potential enforcement cost for the amount due on the annual invoice. Rates are from the FY 2026-27 Environmental Health Branch fee schedule.'
					},
				...
				},
				{
					...
					callout: {
						...
						karl: 'Callout inside the Transaction Section specifics rich-text field. This is the live page’s program-context copy, moved to the end so it explains the fee without delaying the payment decision.'
					},
